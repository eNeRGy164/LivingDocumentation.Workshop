...
❯ dotnet new console --name "PitstopDocumentationRenderer" --framework "net60"
...
To get type information of a spifice type, you can use the `First` extension method. Use the full name as argument.
