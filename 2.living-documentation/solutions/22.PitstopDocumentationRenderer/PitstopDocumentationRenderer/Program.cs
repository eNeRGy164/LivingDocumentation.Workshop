...
using static PitstopDocumentationRenderer.StaticInfo;

var fileContents = File.ReadAllText(@"C:\GitHub\pitstop\pitstop.analyzed.json");
...
static IEnumerable<Statement> FlattenStatements(Statement sourceStatement, List<Statement> statements = null)
{
