...
**Prerequisites**  
For this chapter you need the **.NET SDK** and **git** installed.
...
Considering these points, the **LivingDocumentation Analyzer** dotnet tool was developed.
...
This can take about 20-60 seconds.
