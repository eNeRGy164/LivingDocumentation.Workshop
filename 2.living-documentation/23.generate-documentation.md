...
**Prerequisites**  
For this chapter you need the **.NET SDK** and **Visual Studio 2022** *or* **Visual Studio Code** installed.
...
Now open the file in **Visual Studio Code** and open the preview window.
...
You are already familair with retrieving all commands, so loop over the enumeration and write a chapter per command.
...
You can also notice some commands are listed multiple time. That is because both the sender and handler have their own implementation in their projects.
