...
With the `SourceText.GetSubText` method you can reference a `Span` and get the actual source text.
...
[RAW_STRING_LITERALS]: https://learn.microsoft.com/en-us/dotnet/csharp/whats-new/csharp-11?WT.mc_id=AZ-MVP-5004268#raw-string-literals
