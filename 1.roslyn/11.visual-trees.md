...
**Prerequisites**  
For this chapter we need **Visual Studio 2022** with the **.NET Compiler Platform SDK** and **DGML editor** installed.
...
Make sure, for this example, to select the `Do not use top-level statements` option.

![Select the option to not use top-level statements](images/11.configure-additional-information.png)
